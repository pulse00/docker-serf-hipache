...
if [ ! -d "/home/vagrant/hipache" ]; then
	...
	# fix the bind address of redis so the backend can connect to manipulate hipache backends
	...
	sudo cp /vagrant/hipache/hipache_config.json /home/vagrant/hipache/hipache_config.json
